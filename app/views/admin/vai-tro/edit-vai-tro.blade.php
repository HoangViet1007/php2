...
<div class="container">
     <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-6">
            <form action="./save-edit-vai-tro?id={{$vaiTro->id}}" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="">Tên vai trò : </label>
                    <input type="text" placeholder="Tên vai trò" name="name" class="form-control" value="{{$vaiTro->name}}">
                    @if(isset($nameErr))

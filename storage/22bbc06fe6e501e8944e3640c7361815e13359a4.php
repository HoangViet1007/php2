...
<?php $__env->startSection('title-main','Mua hàng thành công'); ?>
                ...
                <div class="row d-flex justify-content-center align-items-center text-center">
                    <div class="table-order">
                        <div class="form-group">
                            <h4>Chào :&ensp;<span><?php echo e($orders->customer_name); ?></span> !</h4>
                        ...
                        <div class="row d-flex justify-content-center align-items-center"
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;">TM 0<span><?php echo e($orders->id); ?></span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold;"><span style="color: red;"><?php echo e(number_format($orders->total_price)); ?> đ</span></td>
                                </tr>
...
<?php echo $__env->make('homepage.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/homepage/byeCart.blade.php ENDPATH**/ ?>
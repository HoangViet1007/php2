                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="cf_password" placeholder="Nhập lại mật khẩu"
                                class="form-control" value="<?php echo e($user->password); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="address" placeholder="Địa chỉ" class="form-control" value="<?php echo e($user->address); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" placeholder="Số điện thoại" class="form-control" value="<?php echo e($user->phone); ?>">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <select name="vai_tro" class="form-control">
                                    ...
                                    <option <?php if($a->id == $user->vai_tro): ?> selected <?php endif; ?>
                                        value="<?php echo e($a->id); ?>"><?php echo e($a->name); ?></option>
...
<?php echo $__env->make('layout_admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/admin/user/edit-user.blade.php ENDPATH**/ ?>
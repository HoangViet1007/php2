...
<?php $__env->startSection('title-main','Giỏ hàng'); ?>
...
<div class="container">
    ...
    <div class="row mt-2">
        <?php if(isset($errMsg)): ?>
        <p class="text-danger text-center ml-3"><?php echo e($errMsg); ?></p>
        <?php endif; ?>
    </div>
            ...
            <form action="./updatecart" method="POST">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><?php echo e($pr['id']); ?></td>
                            <td><?php echo e($pr['name']); ?></td>
                            <td class="text-center">
                                <img src="./<?php echo e($pr['image']); ?>" alt="" width="60px" height="60px">
                            </td>
                            <td class="text-center"><?php echo e(number_format($pr['price'])); ?>đ</td>
                            <td class="text-center">
                                <input type="number" name="number[<?php echo e($pr['id']); ?>]" value="<?php echo e($pr['number']); ?>" min="1"
                                    class="form-control">
                            </td>
                            <td class="text-center"><?php echo e(number_format($pr['price'] * $pr['number'])); ?> đ</td>
                            <td class="text-center">
                                <a href="./delete-shoppingcart?id=<?php echo e($pr['id']); ?>" class="btn btn-outline-info"><i
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Họ và tên" name="customer_name" class="form-control"
                                value="<?php echo e($_SESSION['khach_hang']['name']); ?>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Địa chỉ" name="customer_address" class="form-control"
                                value="<?php echo e($_SESSION['khach_hang']['address']); ?>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Số điện thoại" name="customer_phone" class="form-control"
                                value="<?php echo e($_SESSION['khach_hang']['phone']); ?>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Email" name="customer_email" class="form-control"
                                value="<?php echo e($_SESSION['khach_hang']['email']); ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Tên khách hàng <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Họ và tên" name="customer_name" class="form-control"
                                value="<?php echo e($_SESSION['admin']['name']); ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Địa chỉ <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Địa chỉ" name="customer_address" class="form-control"
                                value="<?php echo e($_SESSION['admin']['address']); ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Số điện thoại <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Số điện thoại" name="customer_phone" class="form-control"
                                value="<?php echo e($_SESSION['admin']['phone']); ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Email <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Email" name="customer_email" class="form-control"
                                value="<?php echo e($_SESSION['admin']['email']); ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Tên khách hàng <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Họ và tên" name="customer_name" class="form-control">
                            <?php if(isset($customer_nameErr)): ?>
                            <span class="text-danger mt-1"><?php echo e($customer_nameErr); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Địa chỉ <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Địa chỉ" name="customer_address" class="form-control">
                            <?php if(isset($customer_addressErr)): ?>
                            <span class="text-danger mt-1"><?php echo e($customer_addressErr); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Số điện thoại <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Số điện thoại" name="customer_phone" class="form-control">
                            <?php if(isset($customer_phoneErr)): ?>
                            <span class="text-danger mt-1"><?php echo e($customer_phoneErr); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Email <span style="color: red;">*</span></label>
                            <input type="text" placeholder="Email" name="customer_email" class="form-control">
                            <?php if(isset($customer_emailErr)): ?>
                            <span class="text-danger mt-1"><?php echo e($customer_emailErr); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('homepage.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/homepage/listshoppingCart.blade.php ENDPATH**/ ?>
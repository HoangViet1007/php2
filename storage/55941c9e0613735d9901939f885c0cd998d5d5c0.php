                    ...
                    <div class="col-md-10">
                        <select name="id_category" id="" class="form-control" style="width: 255px;border-radius: 5px;">
                            <option value="">--Danh mục sản phẩm--</option>
                             ...
                             <option value="<?php echo e($cate->id_category); ?>"><?php echo e($cate->name_category); ?></option>
            ...
            <table class="table table-hover" style="border: 3px solid #FAFAFA;font-size: 13px; text-align: left;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<?php echo e($pro->image); ?>" alt="hinh ảnh" width="60px" height="60px">
                        </td>
                        <td><?php echo e(number_format($pro->price)); ?><u>đ</u></td>
                        <td><?php echo e($pro->sale); ?>%</td>
                        <td><?php echo e($pro->name_cate); ?></td>
                        <td width="250"><?php echo $pro->description; ?></td>
                        <td style="text-align: center;">
                            <a href="./add-image?id=<?php echo e($pro->id); ?>" class="btn btn-warning mb-1"><i class="fa fa-plus"
                                    aria-hidden="true"></i> Add</a>
                            <a href="./list-image?id=<?php echo e($pro->id); ?>" class="btn btn-dark"><i class="fa fa-list-ol"
                                    aria-hidden="true"></i> List</a>
                        </td>
                        <td>
                            <a href="./edit-product?id=<?php echo e($pro->id); ?>" class="btn btn-danger mr-3"><i
                                    class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <a href="./delete-product?id=<?php echo e($pro->id); ?>" class="btn btn-info"
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-8">
            ...
            <div class="pagination mt-3 d-flex justify-content-center">
                ...
                <?php for($t = 1; $t <= $page2; $t++): ?> <li onclick="lickbutton()"><a href="./list-product?page=<?php echo e($t); ?>"
...
<?php echo $__env->make('layout_admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/admin/product/list-product.blade.php ENDPATH**/ ?>
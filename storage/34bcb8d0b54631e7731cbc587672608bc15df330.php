...
<?php $__env->startSection('title-account','Đổi mật khẩu'); ?>
<?php $__env->startSection('title-cn','Đổi mật khẩu'); ?>
            ...
            <div class="col-md-6 contents">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <form action="./save-edit-password?id=<?php echo e($id); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group last mb-4">
                                        ...
                                        <?php if(isset($old_passwordErr)): ?>
                                        <span class="text-danger mt-1"><?php echo e($old_passwordErr); ?></span>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('homepage.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/tai-khoan/edit-password.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>THE MEN | <?php echo $__env->yieldContent('title-account'); ?></title>
        ...
        <div class="row" style="box-shadow: 0px 5px 20px 0px rgba(0, 0, 0, 0.1);">
            ...
            <div class="col-md-4" style="padding-left: 45px;">
                <div class="tt_menu mt-3">
                    <?php if(isset($_SESSION['khach_hang']) && !empty($_SESSION['khach_hang'])): ?>
                    <ul>
                        <li class="nav-item" style="padding-top: 17px; width: 240px;">
                            <!-- <a class="nav-link a" href="./account"
                                style="border: none;" ><i class="fa fa-user-o" aria-hidden="true" style="font-size: 40px;color: #CCA772;"></i>Tài khoản <br><?php echo e($_SESSION['khach_hang']['name']); ?></a> -->
                            <a class="nav-link" href="./account" style="margin-top: -15px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <span><?php echo e($_SESSION['khach_hang']['name']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="nav-link" href="./account" style="margin-top: -15px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">Tài khoản</div>
                                        <div class="row">
                                            <span><?php echo e($_SESSION['admin']['name']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="container">
            <div class="row" style="padding-top:30px;margin-top: 10px;">
                <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <img src="<?php echo e($_SESSION['khach_hang']['image']); ?>" alt="" width="40px" height="40px"
                                style="border-radius: 50%;">
                        </div>

                        <div class="col-md-10" style="padding-left: 40px;">
                            <div class="row"><span>Tài khoản của</span></div>
                            <div class="row"><span style="font-weight: bold; text-transform: uppercase;"><?php echo e($_SESSION['khach_hang']['name']); ?></span></div>
                        </div>
                    </div>
                    <?php elseif(isset($_SESSION['admin']) && !empty($_SESSION['admin'])): ?>
                    <div class="row">
                        <div class="col-md-2">
                            <img src="<?php echo e($_SESSION['admin']['image']); ?>" alt="" width="40px" height="40px"
                                style="border-radius: 50%;">
                        </div>

                        <div class="col-md-10" style="padding-left: 40px;">
                            <div class="row"><span>Tài khoản của</span></div>
                            <div class="row"><span style="font-weight: bold; text-transform: uppercase;"><?php echo e($_SESSION['admin']['name']); ?></span></div>
                        </div>
                    </div>
                    <?php else: ?>
                    <?php endif; ?>
                ...
                <div class="col-md-9">
                    <h3> <?php echo $__env->yieldContent('title-cn'); ?></h3>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div class="col-md-9" style="background-color:#F4F4F4;box-shadow: 0px 0px 0px 3px rgba(0, 0, 0, 0.1);">
                    <?php echo $__env->yieldContent('conten-account'); ?>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/homepage/account.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>THE MEN | <?php echo $__env->yieldContent('title-main'); ?></title>
    ...
    <div class="container-fluid" style="height: 30px; background-color: #F2F2F2; padding: 0px 30px;">
        <div class="row">
            ...
            ?>
                ...
                <a href="./shopppcart" style="color: black; text-decoration: none;"><i class="fa fa-shopping-basket" aria-hidden="true"></i>&ensp;Giỏ hàng (<span style="color: red;" id="pty"><?php echo $number ?></span>)</a>&ensp;|&ensp;<i class="fa fa-phone-square" aria-hidden="true"></i>&ensp;0355755697
                </div>
            </div>
        </div>
    </div>
                        ...
                        <li class="nav-item" style="padding-top: 17px; width: 240px;">
                            <!-- <a class="nav-link a" href="./account"
                                ...
                                <a class="nav-link" href="./account" style="margin-top: -15px;">
                                   <div class="row">
                                       <div class="col-md-3"><i class="fa fa-user-o" aria-hidden="true" style="font-size: 40px;color: #CCA772;margin-top: 8px;"></i></div>
                                       <div class="col-md-9">
...
<?php echo $__env->yieldContent('conten-main'); ?>
<!-- -------------------------------------------------------------- end conten ----------------------------------------------------------------->
    <?php  require_once "./app/views/layout/footer.blade.php" ?>
</body>

</html><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/homepage/main.blade.php ENDPATH**/ ?>
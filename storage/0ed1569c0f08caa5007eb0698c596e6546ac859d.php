...
<body>
    ...
    <div class="container">
        ...
        <div class="login-container">
            <form action="./post-forgot" method="POST">
                ...
                <div class="input-div one focus">
                    ...
                    <div>
                        <input type="text" class="input" placeholder="Username" name="id" required>
                    </div>
                </div>

                <div class="input-div two focus">
                    <div class="i">
                        <i class="fa fa-envelope" aria-hidden="true" style="color: #cca772;"></i>
                    </div>
                ...
                <a href="./login">Login ?</a> <a href="./">Back to home ?</a>
...
</html><?php /**PATH D:\xampp\htdocs\php2\demo2-php2\app\views/tai-khoan/forgot.blade.php ENDPATH**/ ?>